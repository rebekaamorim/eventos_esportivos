...
class EventosRepository{
  ...
  /*static List<Eventos> tabela_futebol = [
    Eventos(nm_evento: 'Estádio Municipal Jack Marin', imagem: imagem, data: 'Todas as sextas-feiras', hora: '09h00', local: 'Rua Muniz de Souza,1119'),
    Eventos(nm_evento: 'C.E. Ermelino Matarazzo', imagem: imagem, data: 'terças e quintas', hora: '07h00 ', local: 'Rua João Euclides Pereira, 308, Jardim Matarazzo'),
    Eventos(nm_evento: 'C.E. Geraldo José De Almeida', imagem: 'imagem', data: 'segunda a sexta', hora: '07h00', local: 'Av. Agenor Couto de Magalhães,32 – Pirituba'),
    Eventos(nm_evento: 'C.E. Joerg Bruder', imagem: imagem, data: 'terças e quintas-feiras', hora: '10h00', local: 'Praça Jânio da Silva Quadros, 150, Vila Maria')
  ];*/
}